...
public class DFSClient implements FSConstants, java.io.Closeable {
  ...
  @Deprecated
  public DFSInputStream open(String src, int buffersize, boolean verifyChecksum,
                             FileSystem.Statistics stats, int k, int m, int n, 
                             int[] fails)
      throws IOException, UnresolvedLinkException {
    return open(src, buffersize, verifyChecksum, k, m, n, fails);
  }
  ...
  public DFSInputStream open(String src, int buffersize, boolean verifyChecksum,
      ...
      throws IOException, UnresolvedLinkException {
    return open(src, buffersize, verifyChecksum, k, m, n, fails, code);
  }
  ...
  public DFSInputStream open(String src, int buffersize, boolean verifyChecksum,
    ...
    checkOpen();
    //    Get block info from namenode
    return new DFSInputStream(this, src, buffersize, verifyChecksum, k, m, n, 
        fails);
  }
