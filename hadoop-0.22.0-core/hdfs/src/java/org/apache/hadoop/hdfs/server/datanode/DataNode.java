...
public class DataNode extends Configured
  ...
  private static final Random R = new Random(23142);
  ...
  //private ByteBuffer[] reserves123 = null;
  //public ByteBuffer getReserve123(int k){
    /*
    if(reserves123 == null){
      reserves123 = new ByteBuffer[4];
      for(int i = 0; i<4; i++)
        reserves123[i] = ByteBuffer.allocateDirect(1024);
      pminit(5, 3, reserves123[0]);
      pminit(9, 5, reserves123[1]);
      pminit(15, 8, reserves123[2]);
      pminit(17, 9, reserves123[3]);
    }
    if(k == 3)
      return reserves123[0];
    if(k == 5)
      return reserves123[1];
    if(k == 8)
      return reserves123[2];
    if(k == 9)
      return reserves123[3];
    */
  //  return null;
  //}
}
