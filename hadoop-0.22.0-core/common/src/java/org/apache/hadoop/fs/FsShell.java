...
public class FsShell extends Configured implements Tool {
  ...
  private FileSystem getSrcFileSystem(Path src, boolean verifyChecksum
    ...
    LOG.info("getSrcFileSystem, Fs type: "+srcFs.getClass().getName());
    /*
    LOG.info("File System type check");
    if(srcFs instanceof DistributedFileSystem)
      LOG.info("It is DistributedFileSystem");
    if(srcFs instanceof DistributedRaidFileSystem)
      LOG.info("It is DistributedRaidFileSystem");
    */
