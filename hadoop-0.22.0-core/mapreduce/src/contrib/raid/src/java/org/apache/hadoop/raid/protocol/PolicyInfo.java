...
public class PolicyInfo implements Writable {
  ...
  public static enum ErasureCodeType {
    PM, PMO, JRS, JRSO, IA, IAO;
    public static ErasureCodeType fromString(String s) {
      if (PM.toString().equalsIgnoreCase(s)) {
        return PM;
      }
      if (JRSO.toString().equalsIgnoreCase(s)) {
        return JRSO;
      }
      if (JRS.toString().equalsIgnoreCase(s)) {
        return JRS;
      }
      if (PMO.toString().equalsIgnoreCase(s)) {
        return PMO;
      }
      if (IA.toString().equalsIgnoreCase(s)) {
        return IA;
      }
      if (IAO.toString().equalsIgnoreCase(s)) {
        return IAO;
      }
      return null;
    }
