...
public class JRSOEncoder extends Encoder {

	native void jrsoEncode(ByteBuffer message, ByteBuffer parity, int k, int m, int bufferSize, ByteBuffer r);

  int seq;

	static{
		System.loadLibrary("jrsoencoder");
	}

  public static final Log LOG = LogFactory.getLog(
                                  "org.apache.hadoop.raid.JRSOEncoder");
  ...
  void performEncode(byte[][] readBufs, byte[][] writeBufs) {
    ...
    */
    ...
    jrsoEncode(dataBufs, parityBufs, stripeSize, paritySize, bufSize, reserve);
